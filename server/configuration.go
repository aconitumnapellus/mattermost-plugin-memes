...
type configuration struct {
	// Enables wether meme images should be posted collapsible
	CollapseMemes bool
}
...
func (p *Plugin) diffConfiguration(newConfiguration *configuration) {
	...
	if newConfiguration.CollapseMemes != oldConfiguration.CollapseMemes {
		configurationDiff["enable_collapse_memes"] = newConfiguration.CollapseMemes
	}
